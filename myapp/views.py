...
from myapp.tasks import send_email, send_review_email_task
...
class CommentView(views.APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            send_review_email_task.delay('Somebody', serializer.validated_data['email'], serializer.validated_data['message'])
